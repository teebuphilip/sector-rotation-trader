...
CSS = """
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .memorial { margin-top: 16px; padding-top: 16px; border-top: 1px solid var(--border); font-size: 11px; font-style: italic; letter-spacing: 0.2px; color: rgba(255,255,255,0.58); }
