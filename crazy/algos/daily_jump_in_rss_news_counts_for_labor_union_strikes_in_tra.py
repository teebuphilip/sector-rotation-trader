...
class DailyJumpInRssNewsCountsForLaborUnionStrikesInTraAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-rss-news-counts-for-labor-union-strikes-in-tra"
    name = "Daily Jump In Rss News Counts For Labor Union Strikes In Transportation Sector"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=transportation+labor+strike&hl=en-US&gl=US&ceid=US:en'], days_back=180)
