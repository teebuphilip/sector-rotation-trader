...
class EvChargerNetworkExpansionVelocitySurgeAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-network-expansion-velocity-surge"
    name = "Ev Charger Network Expansion Velocity Surge"
