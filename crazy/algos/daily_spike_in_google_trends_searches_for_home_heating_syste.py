...
class DailySpikeInGoogleTrendsSearchesForHomeHeatingSysteAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-searches-for-home-heating-syste"
    name = "Daily Spike In Google Trends Searches For Home Heating System Failure Signals Winter Utility Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Spike In Google Trends Searches For Home Heating System Failure Signals Winter Utility Stress', days_back=180)
