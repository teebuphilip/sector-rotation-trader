...
class WeeklyGoogleTrendsSpikeForSmallBusinessLoanDefaultSAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-spike-for-small-business-loan-default-s"
    name = "Weekly Google Trends Spike For Small Business Loan Default Searches"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='small business loan default', days_back=180)
