...
class WeeklySpikeInGoogleTrendsForRailwayCrossingMalfunctiAlgo(CrazyAlgoBase):
    algo_id = "weekly-spike-in-google-trends-for-railway-crossing-malfuncti"
    name = "Weekly Spike In Google Trends For Railway Crossing Malfunction Signals Freight Sector Risk"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='railway crossing malfunction', days_back=180)
