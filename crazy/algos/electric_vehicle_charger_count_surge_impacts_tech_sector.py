...
class ElectricVehicleChargerCountSurgeImpactsTechSectorAlgo(CrazyAlgoBase):
    algo_id = "electric-vehicle-charger-count-surge-impacts-tech-sector"
    name = "Electric Vehicle Charger Count Surge Impacts Tech Sector"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        # === SIGNAL_LOGIC_START ===
        data = fetch_openchargemap_counts(country_code="US", max_results=1000)
