...
class WeeklyGoogleTrendsSurgeInHomeEnergyBillShockSignalsAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-home-energy-bill-shock-signals"
    name = "Weekly Google Trends Surge In Home Energy Bill Shock Signals Bullish Utilities"
