...
class WeeklySurgeInGoogleTrendsForDiyPlumbingRepairSignalAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-diy-plumbing-repair-signal"
    name = "Weekly Surge In Google Trends For Diy Plumbing Repair Signals Consumer Stress Rebound"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='DIY plumbing repair', days_back=180)
