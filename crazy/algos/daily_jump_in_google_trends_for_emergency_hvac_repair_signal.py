...
class DailyJumpInGoogleTrendsForEmergencyHvacRepairSignalAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-emergency-hvac-repair-signal"
    name = "Daily Jump In Google Trends For Emergency Hvac Repair Signals Consumer Home Repair Stress"
