...
class RealEstateSectorWeeklyGoogleTrendsHomeBuyingSurgeAlgo(CrazyAlgoBase):
    algo_id = "real-estate-sector-weekly-google-trends-home-buying-surge"
    name = "Real Estate Sector Weekly Google Trends Home Buying Surge"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='house for sale', days_back=180)
