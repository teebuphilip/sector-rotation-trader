...
class DailyJumpInGoogleTrendsForSolarPanelRepairSearchesAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-solar-panel-repair-searches-"
    name = "Daily Jump In Google Trends For Solar Panel Repair Searches Signals Green Energy Sector Rebound"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Jump In Google Trends For Solar Panel Repair Searches Signals Green Energy Sector Rebound', days_back=180)
