...
class WeeklyJumpInGoogleTrendsForHomeHeatingOilShortageSAlgo(CrazyAlgoBase):
    algo_id = "weekly-jump-in-google-trends-for-home-heating-oil-shortage-s"
    name = "Weekly Jump In Google Trends For Home Heating Oil Shortage Signals Winter Energy Stress"
