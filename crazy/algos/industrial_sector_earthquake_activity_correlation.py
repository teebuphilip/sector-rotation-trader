...
class IndustrialSectorEarthquakeActivityCorrelationAlgo(CrazyAlgoBase):
    algo_id = "industrial-sector-earthquake-activity-correlation"
    name = "Industrial Sector Earthquake Activity Correlation"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        # === SIGNAL_LOGIC_START ===
        data = fetch_earthquake_activity(days_back=30)
