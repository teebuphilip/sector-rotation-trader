...
class WeeklyIncreaseInUsgsEarthquakeActivityWithinKeyLogisAlgo(CrazyAlgoBase):
    algo_id = "weekly-increase-in-usgs-earthquake-activity-within-key-logis"
    name = "Weekly Increase In Usgs Earthquake Activity Within Key Logistics Hubs Signals Potential Freight Delays"
