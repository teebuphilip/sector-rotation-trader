...
class EvChargerNetworkExpansionSentimentSurgeAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-network-expansion-sentiment-surge"
    name = "Ev Charger Network Expansion Sentiment Surge"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='EV charging', days_back=180)
