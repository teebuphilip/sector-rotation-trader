...
class XluWeeklyColdSnapWeatherCorrelationAlgo(CrazyAlgoBase):
    algo_id = "xlu-weekly-cold-snap-weather-correlation"
    name = "Xlu Weekly Cold Snap Weather Correlation"
