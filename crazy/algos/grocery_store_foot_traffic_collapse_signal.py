...
class GroceryStoreFootTrafficCollapseSignalAlgo(CrazyAlgoBase):
    algo_id = "grocery-store-foot-traffic-collapse-signal"
    name = "Grocery Store Foot Traffic Collapse Signal"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='grocery delivery', days_back=180)
