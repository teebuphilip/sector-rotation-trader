...
class HealthInsuranceDeductibleShockSearchesAlgo(CrazyAlgoBase):
    algo_id = "health-insurance-deductible-shock-searches"
    name = "Health Insurance Deductible Shock Searches"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='high deductible health plan', days_back=180)
