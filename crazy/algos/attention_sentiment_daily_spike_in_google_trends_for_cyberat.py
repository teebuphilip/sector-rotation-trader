...
class AttentionSentimentDailySpikeInGoogleTrendsForCyberatAlgo(CrazyAlgoBase):
    algo_id = "attention-sentiment-daily-spike-in-google-trends-for-cyberat"
    name = "Attention Sentiment Daily Spike In Google Trends For Cyberattack Searches Boosts Cybersecurity Etf"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='cyberattack', days_back=180)
