...
class ElectricityDemandSpikeWeatherAnomalyAlgo(CrazyAlgoBase):
    algo_id = "electricity-demand-spike-weather-anomaly"
    name = "Electricity Demand Spike Weather Anomaly"
