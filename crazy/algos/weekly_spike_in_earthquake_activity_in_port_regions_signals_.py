...
class WeeklySpikeInEarthquakeActivityInPortRegionsSignalsAlgo(CrazyAlgoBase):
    algo_id = "weekly-spike-in-earthquake-activity-in-port-regions-signals-"
    name = "Weekly Spike In Earthquake Activity In Port Regions Signals Potential Freight Logistics Disruption"
