...
class WeeklyGoogleTrendsSpikeInSearchesForHomeSolarPanelAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-spike-in-searches-for-home-solar-panel-"
    name = "Weekly Google Trends Spike In Searches For Home Solar Panel Repair Signals Green Energy Sector Repair Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Spike In Searches For Home Solar Panel Repair Signals Green Energy Sector Repair Demand', days_back=180)
