...
class FinancialSectorWeeklyDrawdownBounceAlgo(CrazyAlgoBase):
    algo_id = "financial-sector-weekly-drawdown-bounce"
    name = "Financial Sector Weekly Drawdown Bounce"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        # === SIGNAL_LOGIC_START ===
        data = fetch_prices(tickers=['XLF'], period="2y")
