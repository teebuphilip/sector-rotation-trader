...
class EvChargerNetworkContractionSignalsElectricVehicleAdopAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-network-contraction-signals-electric-vehicle-adop"
    name = "Ev Charger Network Contraction Signals Electric Vehicle Adoption Slowdown"
