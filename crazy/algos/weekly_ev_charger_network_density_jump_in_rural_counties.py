...
class WeeklyEvChargerNetworkDensityJumpInRuralCountiesAlgo(CrazyAlgoBase):
    algo_id = "weekly-ev-charger-network-density-jump-in-rural-counties"
    name = "Weekly Ev Charger Network Density Jump In Rural Counties"
