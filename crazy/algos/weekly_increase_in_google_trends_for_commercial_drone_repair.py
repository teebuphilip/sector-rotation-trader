...
class WeeklyIncreaseInGoogleTrendsForCommercialDroneRepairAlgo(CrazyAlgoBase):
    algo_id = "weekly-increase-in-google-trends-for-commercial-drone-repair"
    name = "Weekly Increase In Google Trends For Commercial Drone Repair Signals Tech Sector Maintenance Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='commercial drone repair', days_back=180)
