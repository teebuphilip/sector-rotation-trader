...
class CommunicationsSectorRssNewsCountSpikeAlgo(CrazyAlgoBase):
    algo_id = "communications-sector-rss-news-count-spike"
    name = "Communications Sector Rss News Count Spike"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        # === SIGNAL_LOGIC_START ===
        data = fetch_rss_counts(feed_urls=[], days_back=30)
