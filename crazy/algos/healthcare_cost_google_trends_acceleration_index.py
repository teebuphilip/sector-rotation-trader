...
class HealthcareCostGoogleTrendsAccelerationIndexAlgo(CrazyAlgoBase):
    algo_id = "healthcare-cost-google-trends-acceleration-index"
    name = "Healthcare Cost Google Trends Acceleration Index"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='medical bill debt', days_back=180)
