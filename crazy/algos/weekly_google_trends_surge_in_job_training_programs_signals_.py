...
class WeeklyGoogleTrendsSurgeInJobTrainingProgramsSignalsAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-job-training-programs-signals-"
    name = "Weekly Google Trends Surge In Job Training Programs Signals Bullish Industrial Sector"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='job training programs', days_back=180)
