...
class DailySpikeInGoogleTrendsForEmergencyVehicleBatteryRAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-for-emergency-vehicle-battery-r"
    name = "Daily Spike In Google Trends For Emergency Vehicle Battery Replacement Searches Signals Auto Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Spike In Google Trends For Emergency Vehicle Battery Replacement Searches Signals Auto Stress', days_back=180)
