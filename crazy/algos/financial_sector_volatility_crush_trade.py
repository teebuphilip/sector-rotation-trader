...
class FinancialSectorVolatilityCrushTradeAlgo(CrazyAlgoBase):
    algo_id = "financial-sector-volatility-crush-trade"
    name = "Financial Sector Volatility Crush Trade"
