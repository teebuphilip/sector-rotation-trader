...
class XlcWeeklyGoogleTrendsSurgeIn5GRolloutAlgo(CrazyAlgoBase):
    algo_id = "xlc-weekly-google-trends-surge-in-5g-rollout"
    name = "Xlc Weekly Google Trends Surge In 5g Rollout"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='5G rollout', days_back=180)
