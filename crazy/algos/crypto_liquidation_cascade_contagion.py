...
class CryptoLiquidationCascadeContagionAlgo(CrazyAlgoBase):
    algo_id = "crypto-liquidation-cascade-contagion"
    name = "Crypto Liquidation Cascade Contagion"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='crypto liquidation', days_back=180)
