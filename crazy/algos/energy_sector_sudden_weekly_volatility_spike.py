...
class EnergySectorSuddenWeeklyVolatilitySpikeAlgo(CrazyAlgoBase):
    algo_id = "energy-sector-sudden-weekly-volatility-spike"
    name = "Energy Sector Sudden Weekly Volatility Spike"
    family = ""
