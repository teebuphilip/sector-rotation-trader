...
class WeeklyJumpInGoogleTrendsForJobQuittingSearchesSignaAlgo(CrazyAlgoBase):
    algo_id = "weekly-jump-in-google-trends-for-job-quitting-searches-signa"
    name = "Weekly Jump In Google Trends For Job Quitting Searches Signals Labor Market Tightness Benefiting Financial Sector"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Jump In Google Trends For Job Quitting Searches Signals Labor Market Tightness Benefiting Financial Sector', days_back=180)
