...
class EvChargerDeploymentSprintAccelerationAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-deployment-sprint-acceleration"
    name = "Ev Charger Deployment Sprint Acceleration"
