...
class GoogleTrendsSurgeInBankruptcySearchIntentAlgo(CrazyAlgoBase):
    algo_id = "google-trends-surge-in-bankruptcy-search-intent"
    name = "Google Trends Surge In Bankruptcy Search Intent"
