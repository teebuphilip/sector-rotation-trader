...
class MortgageRefinanceWaveGoogleTrendsSurgeAlgo(CrazyAlgoBase):
    algo_id = "mortgage-refinance-wave-google-trends-surge"
    name = "Mortgage Refinance Wave Google Trends Surge"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='refinance mortgage', days_back=180)
