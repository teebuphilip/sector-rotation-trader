...
class WeeklyIncreaseInGoogleTrendsSearchesForSmallBusinessAlgo(CrazyAlgoBase):
    algo_id = "weekly-increase-in-google-trends-searches-for-small-business"
    name = "Weekly Increase In Google Trends Searches For Small Business Loan Default Signals Rising Credit Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Increase In Google Trends Searches For Small Business Loan Default Signals Rising Credit Stress', days_back=180)
