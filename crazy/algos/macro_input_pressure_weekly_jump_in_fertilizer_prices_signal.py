...
class MacroInputPressureWeeklyJumpInFertilizerPricesSignalAlgo(CrazyAlgoBase):
    algo_id = "macro-input-pressure-weekly-jump-in-fertilizer-prices-signal"
    name = "Macro Input Pressure Weekly Jump In Fertilizer Prices Signals Agricultural Sector Rotation"
