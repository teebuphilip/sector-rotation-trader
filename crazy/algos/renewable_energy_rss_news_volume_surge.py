...
class RenewableEnergyRssNewsVolumeSurgeAlgo(CrazyAlgoBase):
    algo_id = "renewable-energy-rss-news-volume-surge"
    name = "Renewable Energy Rss News Volume Surge"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=Renewable+Energy+Rss+News+Volume+Surge&hl=en-US&gl=US&ceid=US:en'], days_back=180)
