...
class WeeklySurgeInGoogleTrendsForElectricScooterTheftSigAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-electric-scooter-theft-sig"
    name = "Weekly Surge In Google Trends For Electric Scooter Theft Signals Consumer Discretionary Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='electric scooter theft', days_back=180)
