...
class WeeklyJumpInGoogleTrendsForWarehouseLaborShortageSiAlgo(CrazyAlgoBase):
    algo_id = "weekly-jump-in-google-trends-for-warehouse-labor-shortage-si"
    name = "Weekly Jump In Google Trends For Warehouse Labor Shortage Signals Supply Chain Labor Stress And Industrial Sector Risk"
    family = "labor_jobs"
