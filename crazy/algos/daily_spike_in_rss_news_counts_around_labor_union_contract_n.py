...
class DailySpikeInRssNewsCountsAroundLaborUnionContractNAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-news-counts-around-labor-union-contract-n"
    name = "Daily Spike In Rss News Counts Around Labor Union Contract Negotiation Signals Bearish Xlf"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=labor+union+contract+negotiation&hl=en-US&gl=US&ceid=US:en'], days_back=180)
