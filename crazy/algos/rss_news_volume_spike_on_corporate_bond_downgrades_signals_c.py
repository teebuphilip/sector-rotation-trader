...
class RssNewsVolumeSpikeOnCorporateBondDowngradesSignalsCAlgo(CrazyAlgoBase):
    algo_id = "rss-news-volume-spike-on-corporate-bond-downgrades-signals-c"
    name = "Rss News Volume Spike On Corporate Bond Downgrades Signals Credit Stress Rotation"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=credit+downgrade&hl=en-US&gl=US&ceid=US:en'], days_back=180)
