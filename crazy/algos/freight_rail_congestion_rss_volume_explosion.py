...
class FreightRailCongestionRssVolumeExplosionAlgo(CrazyAlgoBase):
    algo_id = "freight-rail-congestion-rss-volume-explosion"
    name = "Freight Rail Congestion Rss Volume Explosion"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=Freight+Rail+Congestion+Rss+Volume+Explosion&hl=en-US&gl=US&ceid=US:en'], days_back=180)
