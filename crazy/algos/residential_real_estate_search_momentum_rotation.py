...
class ResidentialRealEstateSearchMomentumRotationAlgo(CrazyAlgoBase):
    algo_id = "residential-real-estate-search-momentum-rotation"
    name = "Residential Real Estate Search Momentum Rotation"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='home for sale near me', days_back=180)
