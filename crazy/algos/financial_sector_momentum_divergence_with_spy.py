...
class FinancialSectorMomentumDivergenceWithSpyAlgo(CrazyAlgoBase):
    algo_id = "financial-sector-momentum-divergence-with-spy"
    name = "Financial Sector Momentum Divergence With Spy"
