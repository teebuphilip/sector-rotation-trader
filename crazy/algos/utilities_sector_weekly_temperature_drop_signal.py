...
class UtilitiesSectorWeeklyTemperatureDropSignalAlgo(CrazyAlgoBase):
    algo_id = "utilities-sector-weekly-temperature-drop-signal"
    name = "Utilities Sector Weekly Temperature Drop Signal"
