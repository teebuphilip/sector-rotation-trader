...
class ConsumerStressSpikeFromGoogleTrendsOnUrgentApplianceAlgo(CrazyAlgoBase):
    algo_id = "consumer-stress-spike-from-google-trends-on-urgent-appliance"
    name = "Consumer Stress Spike From Google Trends On Urgent Appliance Repair Searches"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Consumer Stress Spike From Google Trends On Urgent Appliance Repair Searches', days_back=180)
