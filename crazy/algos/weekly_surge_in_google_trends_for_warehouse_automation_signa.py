...
class WeeklySurgeInGoogleTrendsForWarehouseAutomationSignaAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-warehouse-automation-signa"
    name = "Weekly Surge In Google Trends For Warehouse Automation Signals Industrial Sector Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='warehouse automation', days_back=180)
