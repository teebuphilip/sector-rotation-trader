...
class HealthcareProcedureGoogleTrendsDemandResurgenceAlgo(CrazyAlgoBase):
    algo_id = "healthcare-procedure-google-trends-demand-resurgence"
    name = "Healthcare Procedure Google Trends Demand Resurgence"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='cosmetic surgery near me', days_back=180)
