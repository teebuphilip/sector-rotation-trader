...
class GoogleTrendsSurgeInFlightDelayComplaintsAlgo(CrazyAlgoBase):
    algo_id = "google-trends-surge-in-flight-delay-complaints"
    name = "Google Trends Surge In Flight Delay Complaints"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='flight delays', days_back=180)
