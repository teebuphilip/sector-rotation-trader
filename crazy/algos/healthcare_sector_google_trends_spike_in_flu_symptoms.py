...
class HealthcareSectorGoogleTrendsSpikeInFluSymptomsAlgo(CrazyAlgoBase):
    algo_id = "healthcare-sector-google-trends-spike-in-flu-symptoms"
    name = "Healthcare Sector Google Trends Spike In Flu Symptoms"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='flu symptoms', days_back=180)
