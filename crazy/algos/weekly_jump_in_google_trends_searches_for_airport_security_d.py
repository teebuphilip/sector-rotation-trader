...
class WeeklyJumpInGoogleTrendsSearchesForAirportSecurityDAlgo(CrazyAlgoBase):
    algo_id = "weekly-jump-in-google-trends-searches-for-airport-security-d"
    name = "Weekly Jump In Google Trends Searches For Airport Security Delay Signals Travel Mobility Disruptions"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Jump In Google Trends Searches For Airport Security Delay Signals Travel Mobility Disruptions', days_back=180)
