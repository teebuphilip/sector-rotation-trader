...
class WeeklyGoogleTrendsSpikeForUrgentJobResignationSearchAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-spike-for-urgent-job-resignation-search"
    name = "Weekly Google Trends Spike For Urgent Job Resignation Searches Signals Labor Market Stress"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Spike For Urgent Job Resignation Searches Signals Labor Market Stress', days_back=180)
