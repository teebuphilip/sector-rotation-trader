...
class RentalCarShortageVolatilitySpikeAlgo(CrazyAlgoBase):
    algo_id = "rental-car-shortage-volatility-spike"
    name = "Rental Car Shortage Volatility Spike"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='rental car prices', days_back=180)
