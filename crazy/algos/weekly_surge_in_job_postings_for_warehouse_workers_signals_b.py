...
class WeeklySurgeInJobPostingsForWarehouseWorkersSignalsBAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-job-postings-for-warehouse-workers-signals-b"
    name = "Weekly Surge In Job Postings For Warehouse Workers Signals Bullish Xli"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=warehouse+worker&hl=en-US&gl=US&ceid=US:en'], days_back=180)
