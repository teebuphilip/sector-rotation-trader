...
class WeeklySurgeInGoogleTrendsForFreightCongestionComplaiAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-freight-congestion-complai"
    name = "Weekly Surge In Google Trends For Freight Congestion Complaints Correlating With Industrial Sector Risk"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Surge In Google Trends For Freight Congestion Complaints Correlating With Industrial Sector Risk', days_back=180)
