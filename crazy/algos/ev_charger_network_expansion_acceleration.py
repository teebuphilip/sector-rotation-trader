...
class EvChargerNetworkExpansionAccelerationAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-network-expansion-acceleration"
    name = "Ev Charger Network Expansion Acceleration"
