...
class MaterialsSectorWeeklyVolatilityContractionBreakoutAlgo(CrazyAlgoBase):
    algo_id = "materials-sector-weekly-volatility-contraction-breakout"
    name = "Materials Sector Weekly Volatility Contraction Breakout"
    family = ""
