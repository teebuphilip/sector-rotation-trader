...
class WeeklyGoogleTrendsSurgeInHomeApplianceRepairSearchesAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-home-appliance-repair-searches"
    name = "Weekly Google Trends Surge In Home Appliance Repair Searches Signals Bullish Consumer Discretionary"
