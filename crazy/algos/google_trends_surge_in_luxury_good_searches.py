...
class GoogleTrendsSurgeInLuxuryGoodSearchesAlgo(CrazyAlgoBase):
    algo_id = "google-trends-surge-in-luxury-good-searches"
    name = "Google Trends Surge In Luxury Good Searches"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='luxury watches', days_back=180)
