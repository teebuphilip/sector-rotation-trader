...
class ConsumerDiscretionaryWeeklyGoogleTrendsSurgeAlgo(CrazyAlgoBase):
    algo_id = "consumer-discretionary-weekly-google-trends-surge"
    name = "Consumer Discretionary Weekly Google Trends Surge"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        # === SIGNAL_LOGIC_START ===
        data = fetch_google_trends(keyword="Consumer Discretionary Weekly Google", days_back=90)
