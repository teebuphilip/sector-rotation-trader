...
class AttentionSentimentSpikeDailySurgeInNewsRssCountsMenAlgo(CrazyAlgoBase):
    algo_id = "attention-sentiment-spike-daily-surge-in-news-rss-counts-men"
    name = "Attention Sentiment Spike Daily Surge In News Rss Counts Mentioning Cyberattack Triggers Bullish Xlc"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=cyberattack&hl=en-US&gl=US&ceid=US:en'], days_back=180)
