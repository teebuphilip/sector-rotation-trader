...
class DailySpikeInRssNewsCountsOnCorporateDividendCutsAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-news-counts-on-corporate-dividend-cuts"
    name = "Daily Spike In Rss News Counts On Corporate Dividend Cuts"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=dividend+cut&hl=en-US&gl=US&ceid=US:en'], days_back=180)
