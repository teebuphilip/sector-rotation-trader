...
class DailyStockPriceVolatilitySpikeInXluRelativeToSpyAlgo(CrazyAlgoBase):
    algo_id = "daily-stock-price-volatility-spike-in-xlu-relative-to-spy"
    name = "Daily Stock Price Volatility Spike In Xlu Relative To Spy"
