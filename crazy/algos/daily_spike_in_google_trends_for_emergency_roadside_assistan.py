...
class DailySpikeInGoogleTrendsForEmergencyRoadsideAssistanAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-for-emergency-roadside-assistan"
    name = "Daily Spike In Google Trends For Emergency Roadside Assistance Searches Signals Consumer Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Spike In Google Trends For Emergency Roadside Assistance Searches Signals Consumer Stress', days_back=180)
