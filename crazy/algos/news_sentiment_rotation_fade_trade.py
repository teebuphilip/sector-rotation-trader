...
class NewsSentimentRotationFadeTradeAlgo(CrazyAlgoBase):
    algo_id = "news-sentiment-rotation-fade-trade"
    name = "News Sentiment Rotation Fade Trade"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=recession&hl=en-US&gl=US&ceid=US:en'], days_back=180)
