...
class DailySurgeInGoogleTrendsForElectricBikeRepairSignalAlgo(CrazyAlgoBase):
    algo_id = "daily-surge-in-google-trends-for-electric-bike-repair-signal"
    name = "Daily Surge In Google Trends For Electric Bike Repair Signals Bullish Consumer Discretionary"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='electric bike repair', days_back=180)
