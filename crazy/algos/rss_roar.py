...
class RssRoarAlgo(CrazyAlgoBase):
    algo_id = "rss-roar"
    name = "Rss Roar"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=Rss+Roar&hl=en-US&gl=US&ceid=US:en'], days_back=180)
