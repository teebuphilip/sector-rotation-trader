...
class DailyJumpInGoogleTrendsForEmergencyDentalCareSignalAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-emergency-dental-care-signal"
    name = "Daily Jump In Google Trends For Emergency Dental Care Signals Consumer Stress Lifting Healthcare Sector Demand"
