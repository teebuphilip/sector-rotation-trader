...
class WeeklyGoogleTrendsSurgeForUsedTruckPurchaseSearchesAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-used-truck-purchase-searches-"
    name = "Weekly Google Trends Surge For Used Truck Purchase Searches Signals Bullish Freight Logistics"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge For Used Truck Purchase Searches Signals Bullish Freight Logistics', days_back=180)
