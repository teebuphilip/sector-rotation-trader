...
class PetEmergencyVetVisitSpikeAlgo(CrazyAlgoBase):
    algo_id = "pet-emergency-vet-visit-spike"
    name = "Pet Emergency Vet Visit Spike"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='emergency vet', days_back=180)
