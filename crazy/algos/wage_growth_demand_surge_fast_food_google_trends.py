...
class WageGrowthDemandSurgeFastFoodGoogleTrendsAlgo(CrazyAlgoBase):
    algo_id = "wage-growth-demand-surge-fast-food-google-trends"
    name = "Wage Growth Demand Surge Fast Food Google Trends"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='fast food hiring', days_back=180)
