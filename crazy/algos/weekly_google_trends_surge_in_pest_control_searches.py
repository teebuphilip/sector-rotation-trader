...
class WeeklyGoogleTrendsSurgeInPestControlSearchesAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-pest-control-searches"
    name = "Weekly Google Trends Surge In Pest Control Searches"
