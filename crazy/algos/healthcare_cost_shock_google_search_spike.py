...
class HealthcareCostShockGoogleSearchSpikeAlgo(CrazyAlgoBase):
    algo_id = "healthcare-cost-shock-google-search-spike"
    name = "Healthcare Cost Shock Google Search Spike"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='medical debt', days_back=180)
