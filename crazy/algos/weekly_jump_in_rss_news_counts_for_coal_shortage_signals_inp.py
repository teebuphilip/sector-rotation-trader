...
class WeeklyJumpInRssNewsCountsForCoalShortageSignalsInpAlgo(CrazyAlgoBase):
    algo_id = "weekly-jump-in-rss-news-counts-for-coal-shortage-signals-inp"
    name = "Weekly Jump In Rss News Counts For Coal Shortage Signals Input Cost Pressure In Materials"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=coal+shortage&hl=en-US&gl=US&ceid=US:en'], days_back=180)
