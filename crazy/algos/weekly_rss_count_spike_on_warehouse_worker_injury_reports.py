...
class WeeklyRssCountSpikeOnWarehouseWorkerInjuryReportsAlgo(CrazyAlgoBase):
    algo_id = "weekly-rss-count-spike-on-warehouse-worker-injury-reports"
    name = "Weekly Rss Count Spike On Warehouse Worker Injury Reports"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=Weekly+Rss+Count+Spike+On+Warehouse+Worker+Injury+Reports&hl=en-US&gl=US&ceid=US:en'], days_back=180)
