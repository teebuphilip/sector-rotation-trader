...
class GoogleTrendsSpikeInBankruptcyFilingAndDebtConsolidatAlgo(CrazyAlgoBase):
    algo_id = "google-trends-spike-in-bankruptcy-filing-and-debt-consolidat"
    name = "Google Trends Spike In Bankruptcy Filing And Debt Consolidation Signals Consumer Default Risk Surge"
