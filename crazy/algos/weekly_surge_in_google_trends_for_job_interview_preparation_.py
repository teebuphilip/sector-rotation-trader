...
class WeeklySurgeInGoogleTrendsForJobInterviewPreparationAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-job-interview-preparation-"
    name = "Weekly Surge In Google Trends For Job Interview Preparation Searches"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='job interview preparation', days_back=180)
