...
class EvChargerNetworkDensitySurgeBullishSignalAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-network-density-surge-bullish-signal"
    name = "Ev Charger Network Density Surge Bullish Signal"
