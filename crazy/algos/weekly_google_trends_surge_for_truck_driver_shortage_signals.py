...
class WeeklyGoogleTrendsSurgeForTruckDriverShortageSignalsAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-truck-driver-shortage-signals"
    name = "Weekly Google Trends Surge For Truck Driver Shortage Signals Freight Logistics Risk And Industrial Cost Pressure"
    family = "labor_jobs"
