...
class WeeklySurgeInGoogleTrendsSearchesForDiyBicycleRepaiAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-searches-for-diy-bicycle-repai"
    name = "Weekly Surge In Google Trends Searches For Diy Bicycle Repair"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='DIY bicycle repair', days_back=180)
