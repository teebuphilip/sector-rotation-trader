...
class DailySpikeInRssNewsFeedForSemiconductorChipShortageAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-news-feed-for-semiconductor-chip-shortage"
    name = "Daily Spike In Rss News Feed For Semiconductor Chip Shortage Signals Tech Sector Volatility"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=semiconductor+chip+shortage&hl=en-US&gl=US&ceid=US:en'], days_back=180)
