...
class WeeklyGoogleTrendsSurgeInEnergyBillShockSignalsConsAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-energy-bill-shock-signals-cons"
    name = "Weekly Google Trends Surge In Energy Bill Shock Signals Consumer Stress Impacting Utilities"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='energy bill shock', days_back=180)
