...
class WeeklyGoogleTrendsSurgeForTruckTireReplacementSearchAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-truck-tire-replacement-search"
    name = "Weekly Google Trends Surge For Truck Tire Replacement Searches Signals Industrial Sector Repair Cycle"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge For Truck Tire Replacement Searches Signals Industrial Sector Repair Cycle', days_back=180)
