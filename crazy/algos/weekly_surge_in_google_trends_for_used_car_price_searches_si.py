...
class WeeklySurgeInGoogleTrendsForUsedCarPriceSearchesSiAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-used-car-price-searches-si"
    name = "Weekly Surge In Google Trends For Used Car Price Searches Signaling Consumer Cost Pressure"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Surge In Google Trends For Used Car Price Searches Signaling Consumer Cost Pressure', days_back=180)
