...
class DailySpikeInRssCountsForCybersecurityBreachNewsTrigAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-counts-for-cybersecurity-breach-news-trig"
    name = "Daily Spike In Rss Counts For Cybersecurity Breach News Triggers Bearish Xlk"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=cybersecurity+breach&hl=en-US&gl=US&ceid=US:en'], days_back=180)
