...
class TravelBookingMomentumDivergenceAlgo(CrazyAlgoBase):
    algo_id = "travel-booking-momentum-divergence"
    name = "Travel Booking Momentum Divergence"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='last minute hotel deals', days_back=180)
