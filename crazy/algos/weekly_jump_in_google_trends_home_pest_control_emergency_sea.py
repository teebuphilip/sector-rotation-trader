...
class WeeklyJumpInGoogleTrendsHomePestControlEmergencySeaAlgo(CrazyAlgoBase):
    algo_id = "weekly-jump-in-google-trends-home-pest-control-emergency-sea"
    name = "Weekly Jump In Google Trends Home Pest Control Emergency Searches Signals Consumer Stress And Discretionary Rebound"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Jump In Google Trends Home Pest Control Emergency Searches Signals Consumer Stress And Discretionary Rebound', days_back=180)
