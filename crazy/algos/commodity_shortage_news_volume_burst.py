...
class CommodityShortageNewsVolumeBurstAlgo(CrazyAlgoBase):
    algo_id = "commodity-shortage-news-volume-burst"
    name = "Commodity Shortage News Volume Burst"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=supply+chain&hl=en-US&gl=US&ceid=US:en'], days_back=180)
