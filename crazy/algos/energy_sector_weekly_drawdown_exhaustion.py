...
class EnergySectorWeeklyDrawdownExhaustionAlgo(CrazyAlgoBase):
    algo_id = "energy-sector-weekly-drawdown-exhaustion"
    name = "Energy Sector Weekly Drawdown Exhaustion"
