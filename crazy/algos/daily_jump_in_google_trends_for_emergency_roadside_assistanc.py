...
class DailyJumpInGoogleTrendsForEmergencyRoadsideAssistancAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-emergency-roadside-assistanc"
    name = "Daily Jump In Google Trends For Emergency Roadside Assistance Signals Consumer Stress Impacting Discretionary Sector"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Jump In Google Trends For Emergency Roadside Assistance Signals Consumer Stress Impacting Discretionary Sector', days_back=180)
