...
class DailySurgeInGoogleTrendsForCarRentalPriceSpikeTrigAlgo(CrazyAlgoBase):
    algo_id = "daily-surge-in-google-trends-for-car-rental-price-spike-trig"
    name = "Daily Surge In Google Trends For Car Rental Price Spike Triggers Travel Mobility Sector Pullback"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='car rental price spike', days_back=180)
