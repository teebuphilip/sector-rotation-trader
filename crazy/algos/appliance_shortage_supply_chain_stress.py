...
class ApplianceShortageSupplyChainStressAlgo(CrazyAlgoBase):
    algo_id = "appliance-shortage-supply-chain-stress"
    name = "Appliance Shortage Supply Chain Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='appliance shortage', days_back=180)
