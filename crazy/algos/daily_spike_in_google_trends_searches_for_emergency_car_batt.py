...
class DailySpikeInGoogleTrendsSearchesForEmergencyCarBattAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-searches-for-emergency-car-batt"
    name = "Daily Spike In Google Trends Searches For Emergency Car Battery Replacement Signals Consumer Stress Impacting Discretionary"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Spike In Google Trends Searches For Emergency Car Battery Replacement Signals Consumer Stress Impacting Discretionary', days_back=180)
