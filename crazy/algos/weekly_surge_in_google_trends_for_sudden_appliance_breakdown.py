...
class WeeklySurgeInGoogleTrendsForSuddenApplianceBreakdownAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-sudden-appliance-breakdown"
    name = "Weekly Surge In Google Trends For Sudden Appliance Breakdowns Signals Discretionary Sector Rebound"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Surge In Google Trends For Sudden Appliance Breakdowns Signals Discretionary Sector Rebound', days_back=180)
