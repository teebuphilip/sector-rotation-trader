...
class EvChargerRolloutAccelerationGreenEnergySectorTailwindAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-rollout-acceleration-green-energy-sector-tailwind"
    name = "Ev Charger Rollout Acceleration Green Energy Sector Tailwind"
