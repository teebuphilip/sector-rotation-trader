...
class WeeklyGoogleTrendsSurgeInSearchesForHomeSolarInstalAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-searches-for-home-solar-instal"
    name = "Weekly Google Trends Surge In Searches For Home Solar Installation Financing Signals Xle Bullish"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge In Searches For Home Solar Installation Financing Signals Xle Bullish', days_back=180)
