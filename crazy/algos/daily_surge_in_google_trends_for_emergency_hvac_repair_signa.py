...
class DailySurgeInGoogleTrendsForEmergencyHvacRepairSignaAlgo(CrazyAlgoBase):
    algo_id = "daily-surge-in-google-trends-for-emergency-hvac-repair-signa"
    name = "Daily Surge In Google Trends For Emergency Hvac Repair Signals Consumer Stress Boosting Home Improvement"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Surge In Google Trends For Emergency Hvac Repair Signals Consumer Stress Boosting Home Improvement', days_back=180)
