...
class WeeklyGoogleTrendsSpikeForDiyElectronicsRepairSignalAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-spike-for-diy-electronics-repair-signal"
    name = "Weekly Google Trends Spike For Diy Electronics Repair Signals Bullish Tech Sector"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Spike For Diy Electronics Repair Signals Bullish Tech Sector', days_back=180)
