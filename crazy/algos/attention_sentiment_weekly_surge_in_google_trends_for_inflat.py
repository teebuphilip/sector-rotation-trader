...
class AttentionSentimentWeeklySurgeInGoogleTrendsForInflatAlgo(CrazyAlgoBase):
    algo_id = "attention-sentiment-weekly-surge-in-google-trends-for-inflat"
    name = "Attention Sentiment Weekly Surge In Google Trends For Inflation Hedge Searches Indicates Rising Macro Concern"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='inflation hedge', days_back=180)
