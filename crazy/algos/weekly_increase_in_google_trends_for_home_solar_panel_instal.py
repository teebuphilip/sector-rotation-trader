...
class WeeklyIncreaseInGoogleTrendsForHomeSolarPanelInstalAlgo(CrazyAlgoBase):
    algo_id = "weekly-increase-in-google-trends-for-home-solar-panel-instal"
    name = "Weekly Increase In Google Trends For Home Solar Panel Installation Delay Signals Bearish Utilities Sector"
