...
class WeeklyGoogleTrendsSurgeInHomeHeatingOilShortageSignAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-home-heating-oil-shortage-sign"
    name = "Weekly Google Trends Surge In Home Heating Oil Shortage Signals Winter Utility Stress Favoring Utilities Sector"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='heating oil shortage', days_back=180)
