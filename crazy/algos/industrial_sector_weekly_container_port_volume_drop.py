...
class IndustrialSectorWeeklyContainerPortVolumeDropAlgo(CrazyAlgoBase):
    algo_id = "industrial-sector-weekly-container-port-volume-drop"
    name = "Industrial Sector Weekly Container Port Volume Drop"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        # === SIGNAL_LOGIC_START ===
        data = fetch_port_container_volume()
