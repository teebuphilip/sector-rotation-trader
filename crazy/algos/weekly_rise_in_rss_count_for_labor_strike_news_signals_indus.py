...
class WeeklyRiseInRssCountForLaborStrikeNewsSignalsIndusAlgo(CrazyAlgoBase):
    algo_id = "weekly-rise-in-rss-count-for-labor-strike-news-signals-indus"
    name = "Weekly Rise In Rss Count For Labor Strike News Signals Industrial Sector Risk"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=labor+strike&hl=en-US&gl=US&ceid=US:en'], days_back=180)
