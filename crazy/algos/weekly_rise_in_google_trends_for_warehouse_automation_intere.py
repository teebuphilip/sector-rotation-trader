...
class WeeklyRiseInGoogleTrendsForWarehouseAutomationIntereAlgo(CrazyAlgoBase):
    algo_id = "weekly-rise-in-google-trends-for-warehouse-automation-intere"
    name = "Weekly Rise In Google Trends For Warehouse Automation Interest Signals Industrial Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Rise In Google Trends For Warehouse Automation Interest Signals Industrial Demand', days_back=180)
