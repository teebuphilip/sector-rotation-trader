...
class RegionalEarthquakeClusterInsuranceDemandSpikeAlgo(CrazyAlgoBase):
    algo_id = "regional-earthquake-cluster-insurance-demand-spike"
    name = "Regional Earthquake Cluster Insurance Demand Spike"
