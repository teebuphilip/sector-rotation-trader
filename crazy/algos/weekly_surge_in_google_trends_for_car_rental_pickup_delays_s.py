...
class WeeklySurgeInGoogleTrendsForCarRentalPickupDelaysSAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-car-rental-pickup-delays-s"
    name = "Weekly Surge In Google Trends For Car Rental Pickup Delays Signals Travel Disruption"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Surge In Google Trends For Car Rental Pickup Delays Signals Travel Disruption', days_back=180)
