...
class DailySpikeInRssNewsCountsMentioningPoliticianInsiderAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-rss-news-counts-mentioning-politician-insider"
    name = "Daily Spike In Rss News Counts Mentioning Politician Insider Buying Tech Stock Signals Bullish Xlk"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=politician+insider+buying+tech+stock&hl=en-US&gl=US&ceid=US:en'], days_back=180)
