...
class RssNewsVolumeSpikeOnFoodSupplyChainDisruptionsAlgo(CrazyAlgoBase):
    algo_id = "rss-news-volume-spike-on-food-supply-chain-disruptions"
    name = "Rss News Volume Spike On Food Supply Chain Disruptions"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=food+supply&hl=en-US&gl=US&ceid=US:en'], days_back=180)
