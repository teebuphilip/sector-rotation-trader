...
class RssCountSurgeForSupplyChainBottleneckNewsAlgo(CrazyAlgoBase):
    algo_id = "rss-count-surge-for-supply-chain-bottleneck-news"
    name = "Rss Count Surge For Supply Chain Bottleneck News"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=supply+chain+delay&hl=en-US&gl=US&ceid=US:en'], days_back=180)
