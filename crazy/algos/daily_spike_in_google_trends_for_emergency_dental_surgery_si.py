...
class DailySpikeInGoogleTrendsForEmergencyDentalSurgerySiAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-for-emergency-dental-surgery-si"
    name = "Daily Spike In Google Trends For Emergency Dental Surgery Signals Healthcare Consumer Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='emergency dental surgery', days_back=180)
