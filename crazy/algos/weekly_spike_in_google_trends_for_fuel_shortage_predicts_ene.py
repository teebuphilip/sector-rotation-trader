...
class WeeklySpikeInGoogleTrendsForFuelShortagePredictsEneAlgo(CrazyAlgoBase):
    algo_id = "weekly-spike-in-google-trends-for-fuel-shortage-predicts-ene"
    name = "Weekly Spike In Google Trends For Fuel Shortage Predicts Energy Sector Volatility"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='fuel shortage', days_back=180)
