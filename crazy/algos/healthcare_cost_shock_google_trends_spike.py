...
class HealthcareCostShockGoogleTrendsSpikeAlgo(CrazyAlgoBase):
    algo_id = "healthcare-cost-shock-google-trends-spike"
    name = "Healthcare Cost Shock Google Trends Spike"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='health insurance costs', days_back=180)
