...
class DailyJumpInGoogleTrendsForHomeInternetOutageSignalsAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-home-internet-outage-signals"
    name = "Daily Jump In Google Trends For Home Internet Outage Signals Consumer Discretionary Tech Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='home internet outage', days_back=180)
