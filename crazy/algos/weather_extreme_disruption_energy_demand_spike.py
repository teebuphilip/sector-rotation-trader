...
class WeatherExtremeDisruptionEnergyDemandSpikeAlgo(CrazyAlgoBase):
    algo_id = "weather-extreme-disruption-energy-demand-spike"
    name = "Weather Extreme Disruption Energy Demand Spike"
