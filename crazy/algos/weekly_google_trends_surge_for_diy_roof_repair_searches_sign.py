...
class WeeklyGoogleTrendsSurgeForDiyRoofRepairSearchesSignAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-diy-roof-repair-searches-sign"
    name = "Weekly Google Trends Surge For Diy Roof Repair Searches Signals Consumer Stress Impacting Xli"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge For Diy Roof Repair Searches Signals Consumer Stress Impacting Xli', days_back=180)
