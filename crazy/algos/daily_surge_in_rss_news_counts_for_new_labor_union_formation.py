...
class DailySurgeInRssNewsCountsForNewLaborUnionFormationAlgo(CrazyAlgoBase):
    algo_id = "daily-surge-in-rss-news-counts-for-new-labor-union-formation"
    name = "Daily Surge In Rss News Counts For New Labor Union Formations Signals Labor Market Pressure On Industrial Sector"
    family = "labor_jobs"
