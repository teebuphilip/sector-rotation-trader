...
class DailySpikeInGoogleTrendsForFluSymptomSearchesBoostiAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-for-flu-symptom-searches-boosti"
    name = "Daily Spike In Google Trends For Flu Symptom Searches Boosting Healthcare Services Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Spike In Google Trends For Flu Symptom Searches Boosting Healthcare Services Demand', days_back=180)
