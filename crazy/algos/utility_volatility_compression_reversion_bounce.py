...
class UtilityVolatilityCompressionReversionBounceAlgo(CrazyAlgoBase):
    algo_id = "utility-volatility-compression-reversion-bounce"
    name = "Utility Volatility Compression Reversion Bounce"
