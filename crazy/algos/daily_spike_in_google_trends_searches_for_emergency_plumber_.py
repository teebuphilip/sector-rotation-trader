...
class DailySpikeInGoogleTrendsSearchesForEmergencyPlumberAlgo(CrazyAlgoBase):
    algo_id = "daily-spike-in-google-trends-searches-for-emergency-plumber-"
    name = "Daily Spike In Google Trends Searches For Emergency Plumber Signals Consumer Home Repair Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Spike In Google Trends Searches For Emergency Plumber Signals Consumer Home Repair Stress', days_back=180)
