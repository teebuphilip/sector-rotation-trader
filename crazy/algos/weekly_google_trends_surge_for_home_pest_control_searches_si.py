...
class WeeklyGoogleTrendsSurgeForHomePestControlSearchesSiAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-home-pest-control-searches-si"
    name = "Weekly Google Trends Surge For Home Pest Control Searches Signals Consumer Stress Boosting Staples"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge For Home Pest Control Searches Signals Consumer Stress Boosting Staples', days_back=180)
