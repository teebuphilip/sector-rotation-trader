...
class DailyJumpInGoogleTrendsSearchesForElectricVehicleBaAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-searches-for-electric-vehicle-ba"
    name = "Daily Jump In Google Trends Searches For Electric Vehicle Battery Failure Signals Consumer Tech Stress"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Jump In Google Trends Searches For Electric Vehicle Battery Failure Signals Consumer Tech Stress', days_back=180)
