...
class WeeklySurgeInGoogleTrendsDiyHomeRoofingRepairSearchAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-diy-home-roofing-repair-search"
    name = "Weekly Surge In Google Trends Diy Home Roofing Repair Searches Signals Industrial Sector Demand Spike"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Surge In Google Trends Diy Home Roofing Repair Searches Signals Industrial Sector Demand Spike', days_back=180)
