...
class XlbDailyVolatilityContractionBreakoutAlgo(CrazyAlgoBase):
    algo_id = "xlb-daily-volatility-contraction-breakout"
    name = "Xlb Daily Volatility Contraction Breakout"
