...
class WeeklyGoogleTrendsSpikeInSearchesForFoodSupplyChainAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-spike-in-searches-for-food-supply-chain"
    name = "Weekly Google Trends Spike In Searches For Food Supply Chain Disruptions"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='food supply chain disruption', days_back=180)
