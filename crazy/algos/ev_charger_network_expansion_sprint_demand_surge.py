...
class EvChargerNetworkExpansionSprintDemandSurgeAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-network-expansion-sprint-demand-surge"
    name = "Ev Charger Network Expansion Sprint Demand Surge"
