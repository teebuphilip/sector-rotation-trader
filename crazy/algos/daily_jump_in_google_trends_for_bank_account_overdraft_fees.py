...
class DailyJumpInGoogleTrendsForBankAccountOverdraftFeesAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-bank-account-overdraft-fees"
    name = "Daily Jump In Google Trends For Bank Account Overdraft Fees"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='overdraft fees', days_back=180)
