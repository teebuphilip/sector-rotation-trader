...
class FintechDisruptionWaveAlgo(CrazyAlgoBase):
    algo_id = "fintech-disruption-wave"
    name = "Fintech Disruption Wave"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=Fintech+Disruption+Wave&hl=en-US&gl=US&ceid=US:en'], days_back=180)
