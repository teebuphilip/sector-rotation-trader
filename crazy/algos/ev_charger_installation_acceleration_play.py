...
class EvChargerInstallationAccelerationPlayAlgo(CrazyAlgoBase):
    algo_id = "ev-charger-installation-acceleration-play"
    name = "Ev Charger Installation Acceleration Play"
