...
class WeeklySurgeInGoogleTrendsForFreightElevatorRepairSiAlgo(CrazyAlgoBase):
    algo_id = "weekly-surge-in-google-trends-for-freight-elevator-repair-si"
    name = "Weekly Surge In Google Trends For Freight Elevator Repair Signals Industrial Sector Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='freight elevator repair', days_back=180)
