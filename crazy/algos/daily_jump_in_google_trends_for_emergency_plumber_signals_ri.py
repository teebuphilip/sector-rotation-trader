...
class DailyJumpInGoogleTrendsForEmergencyPlumberSignalsRiAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-for-emergency-plumber-signals-ri"
    name = "Daily Jump In Google Trends For Emergency Plumber Signals Rising Local Economy Stress Benefiting Staples"
