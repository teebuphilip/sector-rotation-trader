...
class DailyJumpInRssNewsCountsMentioningLaborStrikeSignalAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-rss-news-counts-mentioning-labor-strike-signal"
    name = "Daily Jump In Rss News Counts Mentioning Labor Strike Signals Imminent Industrial Disruption"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_rss_counts(feed_urls=['https://news.google.com/rss/search?q=Daily+Jump+In+Rss+News+Counts+Mentioning+Labor+Strike+Signals+Imminent+Industrial+Disruption&hl=en-US&gl=US&ceid=US:en'], days_back=180)
