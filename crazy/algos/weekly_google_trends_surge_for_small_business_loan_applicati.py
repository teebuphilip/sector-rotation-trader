...
class WeeklyGoogleTrendsSurgeForSmallBusinessLoanApplicatiAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-small-business-loan-applicati"
    name = "Weekly Google Trends Surge For Small Business Loan Application Signals Financial Sector Activity Boost"
    family = "labor_jobs"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge For Small Business Loan Application Signals Financial Sector Activity Boost', days_back=180)
