...
class TravelMobilityWeeklyIncreaseInGoogleTrendsForRoadTrAlgo(CrazyAlgoBase):
    algo_id = "travel-mobility-weekly-increase-in-google-trends-for-road-tr"
    name = "Travel Mobility Weekly Increase In Google Trends For Road Trip Searches Signals Leisure Travel Pickup"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='road trip', days_back=180)
