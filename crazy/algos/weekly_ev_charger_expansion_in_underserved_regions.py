...
class WeeklyEvChargerExpansionInUnderservedRegionsAlgo(CrazyAlgoBase):
    algo_id = "weekly-ev-charger-expansion-in-underserved-regions"
    name = "Weekly Ev Charger Expansion In Underserved Regions"
