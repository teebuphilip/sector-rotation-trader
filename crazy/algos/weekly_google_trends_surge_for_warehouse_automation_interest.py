...
class WeeklyGoogleTrendsSurgeForWarehouseAutomationInterestAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-for-warehouse-automation-interest"
    name = "Weekly Google Trends Surge For Warehouse Automation Interest Signals Industrial Tech Demand"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Weekly Google Trends Surge For Warehouse Automation Interest Signals Industrial Tech Demand', days_back=180)
