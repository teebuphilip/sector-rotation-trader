...
class DailyJumpInGoogleTrendsSearchesForHomeRenovationPerAlgo(CrazyAlgoBase):
    algo_id = "daily-jump-in-google-trends-searches-for-home-renovation-per"
    name = "Daily Jump In Google Trends Searches For Home Renovation Permits"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='home renovation permit', days_back=180)
