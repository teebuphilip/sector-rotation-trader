...
class EiaElectricityDemandShockReboundSpreadAlgo(CrazyAlgoBase):
    algo_id = "eia-electricity-demand-shock-rebound-spread"
    name = "Eia Electricity Demand Shock Rebound Spread"
