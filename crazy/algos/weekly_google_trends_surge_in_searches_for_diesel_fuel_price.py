...
class WeeklyGoogleTrendsSurgeInSearchesForDieselFuelPriceAlgo(CrazyAlgoBase):
    algo_id = "weekly-google-trends-surge-in-searches-for-diesel-fuel-price"
    name = "Weekly Google Trends Surge In Searches For Diesel Fuel Price Increase"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='diesel fuel price increase', days_back=180)
