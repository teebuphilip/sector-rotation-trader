...
class DailySurgeInGoogleTrendsForUrgentDentalCareSearchesAlgo(CrazyAlgoBase):
    algo_id = "daily-surge-in-google-trends-for-urgent-dental-care-searches"
    name = "Daily Surge In Google Trends For Urgent Dental Care Searches Lifting Healthcare Sector"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='Daily Surge In Google Trends For Urgent Dental Care Searches Lifting Healthcare Sector', days_back=180)
