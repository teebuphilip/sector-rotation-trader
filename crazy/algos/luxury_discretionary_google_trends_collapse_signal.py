...
class LuxuryDiscretionaryGoogleTrendsCollapseSignalAlgo(CrazyAlgoBase):
    algo_id = "luxury-discretionary-google-trends-collapse-signal"
    name = "Luxury Discretionary Google Trends Collapse Signal"
    ...
    def compute_signal(self, as_of: date, state: dict, historical: bool = False):
        ...
        df = fetch_google_trends(keyword='luxury handbag prices', days_back=180)
