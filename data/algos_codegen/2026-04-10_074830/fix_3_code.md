...
from crazy.adapters.reddit import fetch_reddit_data
from crazy.adapters.yahoo_finance import fetch_yahoo_data
...
class RedditGamingThreadSpike(CrazyAlgoBase):
    ...
    def _fetch_reddit_data(self):
        ...
        def _fetch():
            ...
            data = fetch_reddit_data(subreddits, filter_bots=True, filter_spam=True, only_new_posts_comments=True)
            return data
    ...
    def _fetch_yahoo_data(self):
        ...
        def _fetch():
            ...
            prices = fetch_yahoo_data(tickers, ["adjusted_close"])
            return prices
